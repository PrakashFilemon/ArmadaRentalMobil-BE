...
// const { rental_detail } = require("../models");
...
//   // get rentalId
//   const { rentalId } = await paymentUsecase.getBookingIdByTrxId(transactionId);

//   const rentalData = await rentalUsecase.getRental(rentalId);
...
//     const rentalDetailData = await rentailDetail.findAll({
//       where: {
//         rentalId,
//       },
//     });
